                ...
                Box(
                    ...
                    if (foregroundDynamicCoverSource != null) {
                        DynamicCoverVideo(
                            ...
                            modifier = Modifier.fillMaxSize(),
                            cornerRadiusDp = 22f,
                            // PhoneLandscapeCoverImage below (the static-art fallback for this
                            // exact box) already crops explicitly; DynamicCoverVideo was left on
                            // its default (FIT), so a widescreen music video pillarboxed inside
                            // this square slot while a plain cover photo filled it edge-to-edge.
